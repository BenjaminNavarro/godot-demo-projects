...
func _ready():
	...
	camera1.custom_viewport = viewport1
	camera2.custom_viewport = viewport2
...
func _move_cameras():
	var position_difference = _compute_position_difference()
...
#	var player1_position = camera1.unproject_position(player1.position)
	var player1_position = player1.position
	player1_position.x /= screen_size.x;
	player1_position.y /= screen_size.y;

#	var player2_position = camera2.unproject_position(player2.position)
...
func _compute_position_difference():
